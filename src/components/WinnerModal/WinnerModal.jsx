        ...
        <>
            {showWinnerModal && (
                <div className="fixed z-10 top-0 left-0 bg-[rgba(0,0,0,0.5)] h-full w-full">
                    <div 
                        className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex bg-[#fff] justify-center items-center flex-col h-[15rem] w-[30rem] rounded-lg leading-3 gap-3"
                    >
